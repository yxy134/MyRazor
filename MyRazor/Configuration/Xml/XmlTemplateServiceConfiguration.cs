namespace MyRazor.Configuration.Xml
{
    using System;
    ...
    public class XmlTemplateServiceConfiguration : ITemplateServiceConfiguration
    {
        ...
        /// This prevents temp files from being locked (which makes it impossible for MyRazor to delete them).
        ...
        private void InitialiseConfiguration(string name)
        {
            ...
            if (config == null)
                throw new ConfigurationErrorsException("No <MyRazor> configuration section has been defined.");
