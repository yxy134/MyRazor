namespace MyRazor.Compilation
{
    ...
    using Inspectors;
    using Templating;
    using MyRazor.Compilation.ReferenceResolver;
    ...
    public abstract class CompilerServiceBase : ICompilerService
    {
        ...
        private Assembly CurrentDomain_AssemblyResolve(object sender, ResolveEventArgs args)
        {
            ...
            {
                var assemblyReference = reference as MyRazor.Compilation.ReferenceResolver.CompilerReference.DirectAssemblyReference;
            ...
            foreach (var reference in references)
            {
                var fileReference = reference as MyRazor.Compilation.ReferenceResolver.CompilerReference.FileReference;
                ...
                new RazorEngineHost(CodeLanguage, MarkupParserFactory.Create)
                {
                    ...
                    GeneratedClassContext =
                        new GeneratedClassContext(
                            ...
                            "MyRazor.Templating.TemplateWriter", "DefineSection"
#if RAZOR4
...
#pragma warning disable 0618 // Backwards Compat.
            var references =
                ReferenceResolver.GetReferences(
                    context,
                    IncludeAssemblies()
                        .Select(MyRazor.Compilation.ReferenceResolver.CompilerReference.From)
