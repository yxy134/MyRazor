    ...
    public abstract class DirectCompilerServiceBase : CompilerServiceBase, IDisposable
    {
        ...
        private Tuple<CompilerResults, string> Compile(TypeContext context)
        {
            ...
            var @params = new CompilerParameters
            {
                ...
                CompilerOptions =
                    string.Format("/target:library /optimize /define:MyRazor {0}",
...
#pragma warning restore 0618 // Backwards Compat.
        ...
        private Tuple<Type, CompilationData> CompileType_Windows(TypeContext context)
        {
            ...
            /* Exception details: (2015-01-23: https://travis-ci.org/Antaris/MyRazor/builds/47985319)
              ...
              at MyRazor.Compilation.DirectCompilerServiceBase.CompileType (MyRazor.Compilation.TypeContext context) [0x00033] in /home/travis/build/Antaris/MyRazor/src/source/MyRazor.Core/Compilation/DirectCompilerServiceBase.cs:276 
             */ 
