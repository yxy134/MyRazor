...
namespace MyRazor.Compilation.ImpromptuInterface
{
    ...
    {
        /// <summary>
        /// Performs an implicit conversion from <see cref="System.String"/> to <see cref="MyRazor.Compilation.ImpromptuInterface.String_OR_InvokeMemberName"/>.
        /// </summary>
    ...
    public sealed class InvokeMemberName : String_OR_InvokeMemberName
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="System.String"/> to <see cref="MyRazor.Compilation.ImpromptuInterface.InvokeMemberName"/>.
        /// </summary>
        /// <param name="name">The name.</param>
        /// <returns>The result of the conversion.</returns>
