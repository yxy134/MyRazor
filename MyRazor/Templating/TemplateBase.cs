namespace MyRazor.Templating
{
    ...
    public abstract class TemplateBase : ITemplate
    {
        ...
        /// Gets or sets the template service.
        /// </summary>
        [Obsolete("Only provided for backwards compatibility, use MyRazor instead.")]
        ...
        /// </summary>
        [Obsolete("Use the Razor property instead, this is obsolete as it makes it difficult to use the MyRazor namespace within templates.")]
        public IRazorEngineService MyRazor { get { return Razor; } set { Razor = value; } }
#endif
        /// <summary>
        /// Gets or sets the current <see cref="IRazorEngineService"/> instance.
        /// </summary>
